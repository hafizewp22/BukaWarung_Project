            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 border-right">
                        <img style="height: 400px; width: 400px;" src="{{asset('assets/uploads/products/'.$products->image)}}" class="w-100" alt="">
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            {{$products->name}}
                        ...
                        <hr>
                        <label class="fw-bold">Selling Price : Rp. {{number_format($products->selling_price)}}</label>
                    ...
                    <div class="col-md-8">
                        @foreach($reviews as $item)
                            <div class="user-review">
                                <label>{{$item->users->name .' '.$item->users->lname}}</label>
                                ...
                                @php
                                    ...
                                    $rating = \App\Models\Rating::where('prod_id', $products->id)->where('user_id', $item->users->id)->first();
